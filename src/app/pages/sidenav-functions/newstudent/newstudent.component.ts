...
export class NewStudentComponent {
  ...
  createStudent() {
    ...
    this.http.post('https://bigezobackend2025-production.up.railway.app/api/students', newStudent, { params }).subscribe({
      next: (response: any) => {
  ...
  sendEmail() {
    ...
    this.http.post('https://bigezobackend2025-production.up.railway.app/api/send-email', emailData)
      .subscribe({
        next: () => {
  ...
  uploadProfilePicture(studentId: number) {
    ...
    this.http.post(`https://bigezobackend2025-production.up.railway.app/api/students/${studentId}/profile-picture?schoolAdminId=${this.schoolAdminId}`, formData, { responseType: 'text' })
      .subscribe({
        next: () => {
  ...
  deleteProfilePicture(studentId: number) {
    this.profilePictureLoading = true;
    this.http.delete(`https://bigezobackend2025-production.up.railway.app/api/students/${studentId}/profile-picture?schoolAdminId=${this.schoolAdminId}`)
      .subscribe({
        next: () => {
  ...
  uploadStudentVideo(studentId: number) {
    ...
    this.http.post(`https://bigezobackend2025-production.up.railway.app/api/students/${studentId}/video?schoolAdminId=${this.schoolAdminId}`, formData, { responseType: 'text' })
      .subscribe({
        next: () => {
  ...
  deleteStudentVideo(studentId: number) {
    this.studentVideoLoading = true;
    this.http.delete(`https://bigezobackend2025-production.up.railway.app/api/students/${studentId}/video?schoolAdminId=${this.schoolAdminId}`)
      .subscribe({
        next: () => {
  ...
  uploadAdditionalImage(studentId: number, imageNumber: number) {
    ...
    this.http.post(`https://bigezobackend2025-production.up.railway.app/api/students/${studentId}/image/${imageNumber}?schoolAdminId=${this.schoolAdminId}`, formData, { responseType: 'text' })
      .subscribe({
        next: () => {
          img.loading = false;
          img.error = '';
  ...
  deleteAdditionalImage(studentId: number, imageNumber: number) {
    const img = this.additionalImages[imageNumber - 1];
    img.loading = true;
    this.http.delete(`https://bigezobackend2025-production.up.railway.app/api/students/${studentId}/image/${imageNumber}?schoolAdminId=${this.schoolAdminId}`)
      .subscribe({
        next: () => {
          img.file = null;
          img.url = null;
  ...
  editStudent(student: any) {
    ...
    if (this.studentId) {
      this.profilePictureUrl = `https://bigezobackend2025-production.up.railway.app/api/students/${this.studentId}/profile-picture?schoolAdminId=${this.schoolAdminId}&t=${Date.now()}`;
    } else {
      this.profilePictureUrl = null;
    }
